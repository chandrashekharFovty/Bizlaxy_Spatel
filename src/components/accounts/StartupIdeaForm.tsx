    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-6">
        {[
          ...
          { label: "Business Type", name: "businessType", type: "select", options: ["manufacturer", "retailer", "service"] },
          { label: "Industry & Sector", name: "industrySector", type: "select", options: ["tech", "finance", "health"] },
          { label: "Business Model", name: "businessModel", type: "select", options: ["b2b", "b2c", "d2c"] },
        ].map((field) => (
