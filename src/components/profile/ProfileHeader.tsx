...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  return (
    <>
      <div className="flex items-center w-[227px] h-[42px] gap-2 text-2xl text-[#050505] font-bold whitespace-nowrap tracking-[-0.24px] ml-[27px] mt-2 max-md:ml-2.5 z-10">
      ...
      <div className="w-full h-full flex mt-[-68px] flex-col items-stretch pl-[20px] pr-0.5 max-md:max-w-full max-md:pl-5 z-10">
        <div className="flex w-full items-stretch gap-[40px_70px] flex-wrap max-md:max-w-full">
          ...
          <div className="flex w-5/12 items-center gap-2.5 text-base text-[#050505] font-medium text-center tracking-[-0.16px] mt-[97px] max-md:max-w-full max-md:mt-10">
            <button className="w-[146px] h-[54px] text-[#050505] self-stretch bg-[rgba(239,239,239,1)] gap-2.5 my-auto px-5 py-2.5 rounded-[8px] max-md:px-5">
              <Link to="/editprofile">Edit Profile</Link>
            </button>
            <button className="w-[163px] h-[54px] text-[#050505] self-stretch bg-[rgba(239,239,239,1)] gap-2.5 my-auto px-5 py-2.5 rounded-[8px] max-md:px-5">
              Share Profile
            </button>
            <button className="w-[146px] h-[54px] text-[#050505] self-stretch border border-[color:var(--Btn-grdt,#1C4BC4)] bg-[color:var(--Btn-grdt,#f1e9ff)] gap-2.5 whitespace-nowrap my-auto px-8 py-2.5 rounded-[8px] border-solid max-md:px-5">
              Info
            </button>
          </div>
        </div>
        <div className="text-base text-[#050505] font-normal tracking-[-0.16px] mt-5 max-md:max-w-full">
          <div className="text-[#050505] w-[200px] max-w-full text-[22px] font-bold tracking-[-0.22px] rounded-[0px_0px_0px_0px]">
            {fullName}
          </div>
