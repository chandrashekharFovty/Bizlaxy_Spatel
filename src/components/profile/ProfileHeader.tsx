...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  return (
    <>
      <div className="dark:bg-gray-800 dark:text-white flex items-center w-[227px] h-[42px] gap-2 text-xl text-[#050505] font-bold whitespace-nowrap tracking-[-0.24px] ml-[27px] mt-2 max-md:ml-2.5 z-10">
        <div className="dark:text-white text-[#050505] font-bold">
          {username}
        </div>
      ...
      <div className="w-full h-full flex mt-[-68px] flex-col items-stretch pl-[20px] pr-0.5 max-md:max-w-full max-md:pl-5 z-10">
              ...
              <div className="w-[256px] h-[63px] ml-5 max-md:w-full max-md:ml-0">
                <div className="w-full h-full flex items-center gap-[18px] text-[#050505] whitespace-nowrap mt-[88px] max-md:mt-10">
                  <div className="self-stretch flex flex-col items-center justify-center h-full w-[61px] my-auto">
                    ...
                    <div className=" dark:text-white text-[#050505] text-base font-normal tracking-[-0.16px]">
                      Post
                    </div>
                  </div>
                  ...
                  <div className="self-stretch flex flex-col items-center justify-center w-[62px] my-auto">
                    <div className="dark:text-white text-[#050505] text-center text-[26px] font-medium tracking-[-0.26px]">
                      {followingCount}
                    </div>
                    <div className=" dark:text-white text-[#050505] text-base font-normal tracking-[-0.16px]">
                      Following
        ...
        <div className="text-base text-[#050505] font-normal tracking-[-0.16px] mt-5 max-md:max-w-full">
          <div className="dark:text-white text-[#050505] w-[200px] max-w-full text-[22px] font-bold tracking-[-0.22px] rounded-[0px_0px_0px_0px]">
            {fullName}
          </div>
          <div className="dark:text-white text-[#050505] mt-1.5 max-md:max-w-full font-semibold">
            {bio}
          </div>
          <a
            href={website}
            className="dark:text-white inline-block text-[#1C4BC4] mt-1.5 font-medium"
          >
            {website}
          </a>
        </div>
