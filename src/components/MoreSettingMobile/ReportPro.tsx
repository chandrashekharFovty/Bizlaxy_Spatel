    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-16 px-4">
      ...
      <div className="mt-6">
        ...
        <textarea
          ...
          className="w-full border border-gray-400 rounded-lg p-3 mb-4 focus:outline-none focus:border-blue-500 dark:bg-gray-800 dark:text-white"
          rows="5"
        />
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 border border-gray-400 rounded hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            <CiCamera className="text-xl" /> Take Screenshot
          </button>
          <input
            type="file"
            accept="image/*"
