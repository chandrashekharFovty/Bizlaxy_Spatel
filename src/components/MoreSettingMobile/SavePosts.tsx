    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-black dark:text-white">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-800 z-10 border-b border-gray-200 dark:border-gray-700 flex items-center">
        ...
        >
          ...
          <span className="font-bold text-xl ml-4">Saved Posts</span>
        </Link>
      </div>

<div className="pt-24 p-4 space-x-4">
  <div className="border border-gray-400 w-[390px] rounded-full flex overflow-hidden">
    <button
      onClick={() => setActive("all")}
      className={`px-4 py-2 w-1/2 text-center transition 
        ${active === "all" 
          ? "bg-gradient-to-r from-[#9645FF] to-[#1C4BC4] text-white" 
          : "bg-white text-black"}`}
    >
      All Saved
    </button>
